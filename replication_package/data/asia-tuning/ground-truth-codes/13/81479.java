...
// your application to the Home screen.TaskStackBuilder stackBuilder = TaskStackBuilder.create(this);
...
// my_notification_idallows you to update the notification later on.mNotificationManager.notify(my_notification_id, mBuilder.build());;
